...
@section('content')
    ...
    <div class="card" style="max-width: 600px; margin: 0 auto;">
        <form action="{{ route('admin.tenants.store') }}" method="POST">
            ...
            <hr style="margin: 20px 0; border: 0; border-top: 1px solid var(--theme-border, #E6E1EF);">
            <h3 style="font-size: 16px; margin-bottom: 15px; color: var(--theme-primary-dark, #2E1244);">Admin User Details</h3>
