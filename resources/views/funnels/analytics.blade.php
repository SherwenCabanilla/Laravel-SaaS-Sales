...
@section('styles')
    <style>
        ...
        .analytics-toggle-btn i { font-size:13px; }
        .analytics-delivery-meta { display:grid; gap:6px; margin-bottom:12px; }
        .analytics-delivery-meta strong { color:var(--theme-primary, #240E35); }
        ...
        .analytics-kpi-label-wrap { display:flex; align-items:center; gap:8px; }
        .analytics-help-wrap { position:relative; display:inline-flex; }
        .analytics-help-dot { display:inline-flex; align-items:center; justify-content:center; width:18px; height:18px; border-radius:50%; border:1px solid var(--theme-primary, #240E35); color:var(--theme-primary, #240E35); font-size:11px; font-weight:800; background:#fff; cursor:help; line-height:1; }
        .analytics-help-tip { position:absolute; left:50%; top:calc(100% + 8px); transform:translateX(-50%); min-width:220px; max-width:260px; padding:8px 10px; border:1px solid var(--theme-border, #E6E1EF); border-radius:10px; background:#fff; color:var(--theme-primary, #240E35); font-size:12px; font-weight:700; line-height:1.4; box-shadow:0 10px 24px rgba(15,23,42,.12); opacity:0; visibility:hidden; pointer-events:none; z-index:25; text-transform:none; letter-spacing:0; }
        .analytics-help-wrap:hover .analytics-help-tip,
        .analytics-help-wrap:focus-within .analytics-help-tip { opacity:1; visibility:visible; }
        ...
        .analytics-chart-title { display:flex; align-items:center; gap:8px; margin:0 0 14px; }
        .analytics-chart-title h3 { margin:0; }
        ...
        .analytics-modal-close { appearance:none; display:inline-flex; align-items:center; justify-content:center; padding:0; line-height:1; border:1px solid var(--theme-border, #E6E1EF); background:#fff; color:var(--theme-primary, #240E35); width:40px; height:40px; border-radius:999px; font-size:20px; font-weight:800; cursor:pointer; }
        .analytics-modal-close:hover { background:#f8f7fb; border-color:rgba(36, 14, 53, .2); }
        .analytics-modal-body { padding:18px 20px 20px; }
        .analytics-modal-dialog--compact { width:min(640px, calc(100vw - 32px)); border-radius:16px; }
        .analytics-modal-dialog--compact .analytics-modal-head { padding:14px 14px 0; gap:10px; }
        .analytics-modal-dialog--compact .analytics-modal-body { padding:12px 14px 14px; }
        .analytics-modal-dialog--compact .analytics-modal-close { width:34px; height:34px; font-size:16px; }
        ...
        .analytics-inline-form-actions--right { justify-content:flex-end; }
        .analytics-inline-form--compact { gap:6px; }
        .analytics-inline-form--compact textarea { min-height:64px; }
        .analytics-link { color:#1d4ed8; text-decoration:none; font-weight:700; }
        .analytics-product-cell { display:flex; align-items:center; justify-content:space-between; gap:20px; width:100%; }
        .analytics-card .analytics-info-dot { display:grid; place-items:center; box-sizing:border-box; flex:0 0 28px; width:28px; height:28px; min-width:28px; min-height:28px; max-width:28px; max-height:28px; margin:0; border-radius:50%; border:2px solid var(--theme-primary, #240E35); background:#fff; color:var(--theme-primary, #240E35); font-size:14px; font-weight:800; line-height:1; cursor:pointer; user-select:none; }
        .analytics-card .analytics-info-dot:focus-visible { outline:2px solid rgba(36,14,53,.25); outline-offset:2px; }
        .analytics-product-details { display:none; margin-top:10px; padding:10px 12px; border:1px solid var(--theme-border, #E6E1EF); border-radius:10px; background:linear-gradient(180deg, #fff, #faf8ff); }
        .analytics-product-details.is-open { display:block; }
        .analytics-tooltip-grid { display:grid; grid-template-columns:1fr auto; gap:6px 14px; font-size:12px; line-height:1.35; color:var(--theme-primary, #240E35); }
        .analytics-tooltip-grid .label { font-weight:800; color:var(--theme-primary, #240E35); }
        .analytics-tooltip-grid .value { font-weight:800; color:var(--theme-primary, #240E35); text-align:right; }
        .analytics-table-wrap--product { overflow:visible; }
        .analytics-table-wrap--product .analytics-table { width:100%; min-width:0; }
        .analytics-product-pagination { margin-top:12px; display:flex; justify-content:flex-end; align-items:center; gap:8px; flex-wrap:wrap; }
        .analytics-product-page-note { font-size:12px; color:var(--theme-muted, #6B7280); margin-right:auto; }
